...
这是一种Data-Driven而非Knowledge-Driven方法（无法通过类似传统编程手段解决）
```py
...
效果（对于摘了近视眼镜的人来说很像）：
![[Pasted image 20260311090708.png|452]]

决策边界（对于最简单情况）：
![[Pasted image 20260311090859.png|573]]
...
**但是，使用CNN计算的“特征”进行最临近算法很有效**（添加语义）：
